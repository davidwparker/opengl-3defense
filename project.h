...
extern int current_objects_size;
extern int current_objects_atrs;
extern GLfloat current_objects[DEF_CURRENT_OBJS_SIZE][DEF_CURRENT_OBJS_ATRS];
extern GLfloat preview_object[5];
extern int preview;
...
extern float lightY;
extern float white[];
extern unsigned int textures[12];
